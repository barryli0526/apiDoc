 ...
 * @returns {*}
 */
exports.extend = function(deep, target, opt){

    var options;
   // console.log(opt);
    if(typeof opt === 'object' && opt["toObject"]){
        options = opt.toObject();
    ...
    for (var name in options) {
      //  console.log(name);
        ...
        if (deep && copy instanceof Array) {
            target[name] = exports.extend(deep, [], copy);
