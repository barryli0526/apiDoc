...
exports.getCommentsOfArticleFilterByAuthorId = function(articleId, authorIds, pageSize, pageIndex, callback){
    ...
    Comment.find({article_id:articleId, author_id:{$in:authorIds}}).skip(skip)
        .limit(limit)
